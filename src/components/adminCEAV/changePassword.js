      ...
      axios({
        ...
        .then((datos) => {
          if (datos.data.data.getEmpleadosByCorreo[0]) {
            this.setState({
              dataEmpleados: datos.data.data.getEmpleadosByCorreo[0]
            });
          } else {
  ...
  onSubmitBtn = () => {
    if (this.state.pass) {
      axios({
        ...
        .then((datos) => {
          if (
            datos.data.data.updatePasswordEmpleados.message ===
            "actualización exitosa"
          ) {
            alert(
              `Contraseña para ${this.state.dataEmpleados.correo} Actualizada`
            );
        ...
        <Card style={{ width: "70%" }}>
          <table>
            <tr>
              ...
              <td>
                {this.state.dataEmpleados.nombre}&nbsp;
                {this.state.dataEmpleados.apellidos}
              </td>
            </tr>
          </table>
          <center>
        ...
        <div id="apppages2">
          <MDBView>
            <div style={{ marginTop: "3%", marginLeft: "8%" }}>
                ...
                <Card title={titulo} style={{ width: "70%" }}>
                  ...
                  >
                    <center>
                      ...
                      >
                        <Button
                          className="ant-btnText"
                          onClick={(e) => this.validacion()}
              ...
              <MDBCol md="5">{datosClientes}</MDBCol>
            </div>
          </MDBView>
        </div>
      </React.Fragment>
